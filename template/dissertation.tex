...
\logo{EE}{Instituto de Educação}{}
\logoB{EE}{Instituto de Educação}{}
...
\masters{Mestrado em Ensino de Informática}
...
%A versão do template não funcionava
...
\input{chapters/Plano}
\input{chapters/Desenvolvimento}
\input{chapters/Avaliação}
\input{chapters/Outras}
\input{chapters/Conclusão}

\input{chapters/Exemplos} %para apagar
